...
const config = {
  title: 'Make Me Coffee',        // Your website title
  url: 'https://inaki.github.io',          // Your website URL
  project: 'make-me-coffee-web',      // Firebase project. See README.md -> How to Deploy
...
tasks.set('publish', () => {
  const remote = {
    url: 'https://github.com/inaki/make-me-coffee-web.git',
    branch: 'gh-pages',
  };
  global.DEBUG = process.argv.includes('--debug') || false;
